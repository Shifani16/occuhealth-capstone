                ...
                <div class="min-w-full">
                    <div class="overflow-y-auto max-h-[calc(100vh-350px)] border rounded-md">
                        <table class="table-auto text-left border-collapse w-full">
                            ...
                            <tbody>
                                <tr v-for="(item, index) in displayedPasienList" :key="item.no_pasien" class="container-open-sans odd:bg-[#E6F6F9]">
                                    ...
                                    <td class="px-4 py-2 flex">
                                      <button @click="goToDetail(item)" class="cursor-pointer w-10 h-10">
                                        <img src="@/assets/action-info.svg" title="Lihat Info Pasien" class="object-contain" />
                                      </button>
                                      <button @click="goToEdit(item)" class="cursor-pointer w-10 h-10">
